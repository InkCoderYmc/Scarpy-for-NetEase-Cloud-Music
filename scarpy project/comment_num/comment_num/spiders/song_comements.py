...
from comment_num.items import CommentNumItem
...
class SongComementsSpider(scrapy.Spider):
    name = 'song_comements'
    ...
    def start_requests(self):
        song_ids = []
        # 读取每首歌曲对应的歌曲id
        fo = open("/home/ymc/Documents/Python project/网易云音乐爬虫及过程文件/music_163_songs.csv", "r", encoding="utf-8")
        for line in fo:
            line = line.replace("\n", "")
            line_s = line.split(',')
            if line_s[0] != '':
        ...
        count_for_get = 1303796  # 当前进度表示
        continue_ls = song_ids[count_for_get:1330000]
